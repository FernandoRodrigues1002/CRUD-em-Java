...
public class ContatoController {
	...
	public ResponseEntity<Contato> addContato(@PathVariable Long idPessoa, @Valid @RequestBody Contato contato) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Contato> updateContato(@PathVariable Long id, @Valid @RequestBody Contato contatoDetails) {
	    Optional<Contato> contato = contatoRepository.findById(id);
